...
on extensive configurability, massive extensibility and ease of use.`)
	...
	*/
	...
	flagSet.CreateGroup("configs", "Configurations",
		...
		flagSet.StringVar(&options.TLSMode, "tls-mode", "", "override HTTP TLS transport mode (auto, sslv3, gost)"),
		flagSet.StringVar(&options.GOSTOpenSSLBinary, "gost-openssl-binary", "", "OpenSSL binary to use for GOST HTTP requests"),
		flagSet.StringVar(&options.GOSTOpenSSLConfig, "gost-openssl-config", "", "OpenSSL config file to use for GOST HTTP requests"),
